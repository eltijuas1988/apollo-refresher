    ...
    launches: async (_, {pageSize = 20, after}, {dataSources}) => {
      ...
      return {
        ...
        hasMore: launches.length ?
          launches[launches.length - 1].cursor !== allLaunches[allLaunches.length - 1] : false
      }
    },
    ...
    bookTrips: async (_, {launchIds}, {dataSources}) => {
      ...
      return {
        ...
        message: results.length === launchIds.length ?
          'trips booked successfully' : `the following launches couldn't be booked: ${launchIds.filter(
